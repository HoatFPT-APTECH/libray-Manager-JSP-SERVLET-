                ...
                <div class="card card-primary ">
                    ...
                    <form class="p-3" method="POST" action="${pageContext.request.contextPath}/EditBook" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" id="name" name="name" value="<%=book.getName()%>" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input readonly type="number" class="form-control" id="amount" value="<%=book.getAmount()%>" name="amount" required>
                        </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="author">Tác giả:</label>
                              <select readonly class="form-control" name="author_id">
                        ...
                        <div class="form-group">
                            ...
                            <input readonly type="text" class="form-control" id="price" value="<%=book.getPrice()%>" name="price" required>
                        </div>

                        <!-- Số trang -->
                        <div class="form-group">
                            <label for="number_of_pages">Số trang:</label>
                            <input readonly type="number" class="form-control" id="number_of_pages" value="<%=book.getNumberOfPages()%>" name="number_of_pages" required>
                        </div>

                        <!-- Nhà xuất bản -->
                        <div class="form-group">
                            <label for="publisher_id">Nhà xuất bản:</label>
                            <select readonly class="form-control" name="publisher_id">
                        ...
                        <div class="form-group">
                            ...
                            <input readonly type="date" class="form-control" id="publication_year" value="<%=book.getPublicationYear()%>" name="publication_year" required>
                        </div>

                        <!-- Ngày tạo -->
                        <div class="form-group">
                            <label for="create_day">Ngày tạo:</label>
                            <input readonly type="date" class="form-control" id="create_day" value="<%=book.getCreateDay()%>" name="create_day" required>
                        </div>
