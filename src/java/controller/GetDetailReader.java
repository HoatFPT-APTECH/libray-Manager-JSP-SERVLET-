 ...
 * @author hoatd
 */
@WebServlet(name = "GetDetailReader", urlPatterns = {"/GetDetailReader"})
public class GetDetailReader extends HttpServlet {
private ReaderBO serviceReader= new ReaderBO();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       request.setAttribute("page", "detail_reader.jsp");
